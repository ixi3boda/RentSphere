...
// ---------------------------------------------------------------------------
// Mock toggle — flip to false when GET /api/owners/dashboard is ready
// ---------------------------------------------------------------------------
const MOCK_MODE = true;

const MOCK_STATS = {
  totalProperties:  0,   // will be computed from properties array
  pendingRequests:  3,
  activeContracts:  1,
};
  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      if (MOCK_MODE) {
        ...
        // Compute totalProperties from the property context once loaded
        setStats(MOCK_STATS);
      } else {
